...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 06 Mar 2020 pada 04.46
...
(9, 'Muhammad Lutfi', NULL, 11, 'Jawa Timur', 369, 'Kabupaten Probolinggo', 0, '67291', 'Jl. Kyai Haji. Jl. KH. Zaini Mun\'im, Dusun Tj. Lor, Karanganyar, Kec. Paiton', 'wilayah : Zaid Bin Zabits, Gang : J', 17, 'App\\Models\\Konsumen'),
(10, 'Ahmad', NULL, 11, 'Jawa Timur', 369, 'Kabupaten Probolinggo', 0, '67291', 'Jl. Kyai Haji. Jl. KH. Zaini Mun\'im, Dusun Tj. Lor, Karanganyar, Kec. Paiton', 'wilayah : Dalem Timur, Gang : G', 17, 'App\\Models\\Konsumen'),
(11, 'aa', NULL, 11, 'Jawa Timur', 369, 'Kabupaten Probolinggo', 0, '67291', 'Jl. Kyai Haji. Jl. KH. Zaini Mun\'im, Dusun Tj. Lor, Karanganyar, Kec. Paiton', 'wilayah : Dalem Barat, Gang : H', 17, 'App\\Models\\Konsumen');
...
CREATE TABLE `foto_produk` (
  ...
  `foto_produk` varchar(355) NOT NULL,
...
(1, '4967821a953bbb9a2c71d67e44d146d8.png', 1);
...
(17, 1, 17, 'App\\Models\\Konsumen', '2020-02-27 15:53:17', '2020-02-28 21:19:55', 'Y', 8, 5000);
...
(1, 'M. Ilham Surya Pratama', 'ilham', '$2y$10$YkfummEoFgo5DVE1WqQ/nODBlYmeqHcuvEGGwhfAdJhfXklkXj6Yi', 'XtyTF4fNMvwaCmATYQObuLzufMSS8Fy448ZtccXaj1llYXQyFM6a4bDzdrph', '085330150827', NULL, 'ilhamsurya26@gmail.com', 'aktif', '2020-01-04 20:33:34', '2020-02-28 10:57:08', 8),
(17, 'Soleh', 'soleh', '$2y$10$BiOcr6QxhdwPNDKGQn3FTePRizxKCzbGEOsi3HVslPqPpW4IRDA9.', NULL, '123456789123', 'UMqDZFJmmlEgFHE.png', 'ilhamsurya26@gmail.com', 'aktif', '2020-02-27 15:26:01', '2020-02-28 22:28:14', NULL);
...
(1, 'indra', 'e24f6e3ce19ee0728ff1c443e4ff488d', 'santri', 'Toko Indra', 'Brabe', 11, 369, 'Brabe', '67276', '085330150827', '', '', 100000, 'aktif', '2020-01-01 14:53:00', '2020-02-28 11:00:45', 8),
(2, 'yolo', '4fded1464736e77865df232cbcb4cd19', 'santri', 'Toko Yolo', 'Maron', 11, 369, 'RT 11 RW 003 Maron Wetan', '67276', '085330150827', '', '', 0, 'aktif', '2020-01-10 17:18:00', '2020-01-10 17:18:00', 0),
(3, 'indra2', '6194e3b082d44548ba711759cb4f56c0', 'santri', 'Toko Indra 2', 'Brabe', 11, 369, 'Brabe', '67276', '085330150827', '', '', 0, 'aktif', '2020-01-01 14:53:00', '2020-01-01 14:53:00', 0);
...
CREATE TABLE `produk` (
  ...
  `tipe_produk` enum('single','varian') NOT NULL,
...
INSERT INTO `produk` (`id_produk`, `nama_produk`, `slug`, `satuan`, `berat`, `harga_modal`, `harga_jual`, `diskon`, `stok`, `keterangan`, `tipe_produk`, `pelapak_id`, `wishlist`, `terjual`, `created_at`, `updated_at`, `kategori_produk_id`) VALUES
(1, 'Fad', 'fad', '2', 2, 2, 2, 2, 2, '22', 'single', 1, 0, 0, '2020-03-05 15:52:05', '0000-00-00 00:00:00', 1),
(2, 'Mouse Optic', 'mouse-optic', 'buah', 100, 50000, 60000, 1000, 100, 'Mouse optic dengan ini kita bisa menggerakkan cursor di computer/laptop.', 'single', 1, 0, 0, '2020-03-05 22:57:46', '0000-00-00 00:00:00', 2),
(3, 'Keaboard Gaming', 'keaboard-gaming', 'buah', 1000, 100000, 120000, 1000, 100, 'Memiliki Tampilan yg cocok bagi gamers.', 'single', 1, 0, 0, '2020-03-05 22:58:34', '0000-00-00 00:00:00', 2),
(4, 'Camera HD', 'camera-hd', 'buah', 1500, 1000000, 1500000, 2000, 120, 'Dengan kualitas gamber microless, membuat rekaman video anda sangat hebat.', 'single', 1, 0, 0, '2020-03-05 22:59:43', '0000-00-00 00:00:00', 2);
...
CREATE TABLE `rekening_pelapak` (
  ...
  `nomor_rekening` char(25) NOT NULL,
...
(1, 'Mandiri', '03343434', 'Fadil hasan', 1, 0, '');
...
(3, '1583140298', 1, 'App\\Models\\Konsumen', '2020-03-02 09:11:38', 153200),
(4, '1583140300', 1, 'App\\Models\\Konsumen', '2020-03-02 09:11:40', 153200),
(5, '1583140324', 1, 'App\\Models\\Konsumen', '2020-03-02 09:12:04', 175200);
...
(0, 5, 3, 10, 1, 11, '11', '11', 1, '11', 11, 'verifikasi', 11),
(1, 1, 3, 5, 6000, 5, 'jne', 'REG', 20000, '1-2', 50000, 'sukses', 2),
(2, 1, 4, 4, 6000, 0, 'pos', 'Paket Kilat Khusus', 19000, '2-3 HARI', 43000, 'dikirim', 1),
(3, 2, 4, 2, 6000, 0, 'jne', 'CTCYES', 12000, '1-1', 24000, 'verifikasi', 1),
(4, 2, 9, 3, 5000, 0, 'jne', 'CTC', 7000, '1-2', 22000, 'verifikasi', 3),
(5, 3, 2, 2, 4000, 0, 'jne', 'CTCYES', 12000, '1-1', 20000, 'verifikasi', 1),
(6, 3, 4, 1, 6000, 0, 'jne', 'CTCYES', 12000, '1-1', 18000, 'verifikasi', 1),
(7, 3, 4, 19, 6000, 0, 'jne', 'CTCYES', 12000, '1-1', 126000, 'pending', 1),
(8, 4, 2, 2, 4000, 0, 'jne', 'CTCYES', 12000, '1-1', 20000, 'verifikasi', 1),
(9, 4, 4, 1, 6000, 0, 'jne', 'CTCYES', 12000, '1-1', 18000, 'verifikasi', 1),
(10, 4, 4, 19, 6000, 0, 'jne', 'CTCYES', 12000, '1-1', 126000, 'pending', 1),
(13, 5, 4, 19, 6000, 0, 'jne', 'CTCYES', 12000, '1-1', 126000, 'sukses', 1),
(14, 5, 9, 2, 5000, 0, 'jne', 'CTCYES', 12000, '1-1', 22000, 'verifikasi', 3),
(15, 5, 3, 1, 6000, 0, 'tiki', 'REG', 10000, '3', 16000, 'dikirim', 1);
...
(2, 'Muhammad Fadil Hasan', 'admin', '21232f297a57a5a743894a0e4a801fc3'),
(3, 'Rina Nose', 'rina', '3aea9516d222934e35dd30f142fda18c');
...
--
ALTER TABLE `foto_produk`
  MODIFY `id_foto_produk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
